...
class GoogleProfile(ChromeProfile):
    ...
    def login(self):
        ...
        try:
            ...
            # Account has been logged in from another device
                ...
                print("Account has been logged in from another device")
        ...
        if 'challenge/pwd' in driver.current_url:
            ...
            print("Something happened to account")
    ...
    def check_challenge(self):
        ...
        if 'challenge/selection' in driver.current_url:
            print("Google is asking for backup email")
            ...
            print("google said account has been disabled")
